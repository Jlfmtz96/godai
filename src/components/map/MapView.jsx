...
export const MapView = () => {
  ...
  return (
        <div className="relative">
            <div id="map" className="w-full h-[750px] rounded-2xl" />
            <div className="h-96 bg-slate-100 rounded-2xl absolute left-20 top-1/2 transform -translate-y-1/2 z-10 p-4">
                ...
                <div className="grid grid-cols-4 gap-3 justify-center mt-4">
                    ...
                    <button className="flex flex-col items-center">
                        <div className="rounded-full border border-blue-900 w-10 h-10 flex items-center justify-center" onClick={() => handleFilterClick("escuelas")}>
                    ...
                    <button className="flex flex-col items-center">
                        <div className="rounded-full border border-blue-900 w-10 h-10 flex items-center justify-center" onClick={() => handleFilterClick("hospitales")}>
                    ...
                    <button className="flex flex-col items-center">
                        <div className="rounded-full border border-blue-900 w-10 h-10 flex items-center justify-center" onClick={() => handleFilterClick("plazas")}>
